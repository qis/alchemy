...
inline void SKSE_FATALERROR(const char * fmt, ...)
{
	va_list args;
...
inline void SKSE_ERROR(const char * fmt, ...)
{
	va_list args;
...
inline void SKSE_WARNING(const char * fmt, ...)
{
	va_list args;
...
inline void SKSE_MESSAGE(const char * fmt, ...)
{
	va_list args;
...
inline void SKSE_VMESSAGE(const char * fmt, ...)
{
	va_list args;
...
inline void SKSE_DMESSAGE(const char * fmt, ...)
{
	va_list args;
