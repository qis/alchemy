...
namespace papyrusGame
{
	...
	void SetGameSettingFloat(StaticFunctionTag * base, BSFixedString name, float value)
	{
		...
		if(settings)
		{
			...
			if(setting)
			{
				...
				{
					SKSE_WARNING("SetGameSettingFloat: %s is not a float", name.data);
				}
			}
			else
			{
				SKSE_WARNING("SetGameSettingFloat: %s not found", name.data);
			}
		}
	}
	...
	void SetGameSettingInt(StaticFunctionTag * base, BSFixedString name, UInt32 value)
	{
		...
		if(settings)
		{
			...
			if(setting)
			{
				...
				{
					SKSE_WARNING("SetGameSettingInt: %s is not an int", name.data);
				}	
			}
			else
			{
				SKSE_WARNING("SetGameSettingInt: %s not found", name.data);
			}
		}
	}
	...
	void SetGameSettingBool(StaticFunctionTag * base, BSFixedString name, bool value)
	{
		...
		if(settings)
		{
			...
			if(setting)
			{
				...
				{
					SKSE_WARNING("SetGameSettingBool: %s is not a bool", name.data);
				}
			}
			else
			{
				SKSE_WARNING("SetGameSettingBool: %s not found", name.data);
			}
		}
	}
	...
	void SetGameSettingString(StaticFunctionTag * base, BSFixedString name, BSFixedString value)
	{
		...
		if(settings)
		{
			...
			if(setting)
			{
				...
				{
					SKSE_WARNING("SetGameSettingString: %s is not a string", name.data);
				}
			}
			else
			{
				SKSE_WARNING("SetGameSettingString: %s not found", name.data);
			}
		}
	}
	...
	void SetMiscStat(StaticFunctionTag * base, BSFixedString name, UInt32 value)
	{
		...
		if(stat)
			...
			SKSE_MESSAGE("SetMiscStat: could not find stat (%s)", name.data);
	}
